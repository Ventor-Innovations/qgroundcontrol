...
public:
    ...
    QGeoCoordinate      coordinate                  (void) const final { return _landingCoordinate; }
    ...
    void                setEntryCoordinate          (const QGeoCoordinate& coordinate) final { setFinalApproachCoordinate(coordinate); }
